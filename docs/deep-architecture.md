...
C++17, C++ Design Patterns, SOLID, BeagleBone Black, AM335x, Buildroot, U-Boot, Kernel build, microSD boot
...
- Source boundary: `include, src, buildroot`
- Executable entry: `src/main.cpp`
- Test coverage: `tests/BbbBootImageTests.cpp`
