...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for BBB Minimal Buildroot Boot Image. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: BeagleBone Black AM335x project that builds U-Boot, Linux kernel, and a tiny root filesystem with Buildroot for a sub-5-second login prompt. | Scenario tests and documentation review. |
